      ...
      <div className='row mt-4 border-bottom pb-4 pb-4'>
        ...
        <div className='col-lg-6 pe-'>
          ...
          <div className="form-group">
            ...
            <input type="file" id={`q1_document`}className="form-control rounded-0" onChange={onFileChange}/>
            {userDetails.q1_document_file && userDetails.q1_document_file.trim() !== "" && !userDetails.q1_document_file.endsWith("null") ? (
              <div className='mt-2'>
                <a href={userDetails.q1_document_file} target="_blank" rel="noopener noreferrer">
                  View Document
                </a>
              </div>
            ) : null}
        ...
        <div className='col-lg-6 pe-'>
          ...
          <div  className=' h-90 w-100 d-flex align-items-center justify-content-space'>
            <div className="form-group">
              ...
              />
              {userDetails.q2_document_file && userDetails.q2_document_file.trim() !== "" && !userDetails.q2_document_file.endsWith("null") ? (
                <div className='mt-2'>
                  <a href={userDetails.q2_document_file} target="_blank" rel="noopener noreferrer">
                    View Document
                  </a>
                </div>
              ) : null}
