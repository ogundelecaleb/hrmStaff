...
const TradeLeave = ({ navigate }) =>  {
  ...
  const [totalLeaves, setTotalLeave] = useState(parseInt(totalLeave, 10));
  ...
  console.log(fullName,maritalStatus,departmentOrUnitOrFacultyID,dateOfFirstAppointment,rankDesignation,selectedLeaveType,startDate,endDate,addressLeave, durationInDays,totalLeaves);
    ...
    return (
      ...
      >
        <div className='row mt-5 ' style={{ height: "10px", width:"80%"}}>
          ...
          >
            Trade Leave is only entitled to NASE Staff
          </p>
        </div>
