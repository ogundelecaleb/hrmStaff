...
const ResearchLeave = ({ navigate }) => {
  ...
  console.log(fullName,maritalStatus,departmentOrUnitOrFacultyID,dateOfFirstAppointment,rankDesignation,selectedLeaveType,startDate,endDate, leaveDuration, resumptionDate);
