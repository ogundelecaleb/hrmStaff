...
const PaternityLeave = ({ navigate }) =>  {
  ...
  console.log(fullName,maritalStatus,departmentOrUnitOrFacultyID,dateOfFirstAppointment,rankDesignation,selectedLeaveType,startDate,endDate,addressLeave,staffRep,resumptionDate,leaveDuration,birthNum);
          ...
          <form
            ...
            <div class='pb-5' style={{ display: !showAdditionalInfo ? "block" : "none" }}>
              <div class='mb-3 pt-2'>
                ...
                <input class='form-control rounded-0' value={birthNum} onChange={(e) => setBirthNum(e.target.value)}/>
              </div>
              <div class='pb-2'>
