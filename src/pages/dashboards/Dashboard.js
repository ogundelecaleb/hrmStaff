...
export default function Dashboard({ switchRoutes }) {
  ...
  const datar = [
    ...
    },
    {
      ...
      message:
        "filling out the assumption of duty form enables theverificationof your work status",
    },
  ];
          ...
          <div className='row' style={{ marginTop: "-10px" }}>
            <div
              ...
              <div>
                ...
                <p className='fs-4 mt-2 fw-semibold'>1</p>
                <p
                        ...
                        <div className='col-lg-11 mt-5 pt-3 pb-1 ms-3 shadow rounded row'>
                          <div className='col-lg-12'>
                            ...
                            <p
                              ...
                              theverification of your work status
                            </p>
                          </div>
                        </div>
                      </div>
